...
export default function BlogPostClient({ params }: PageProps) {
  ...
  const getArticleSchema = (postData: typeof post) => {
    if (!postData) return null;
    if (postData.slug === "website-conversion-traps") {
      return {
    ...
    if (postData.slug === "meta-ads-seo-integration") {
      return {
        "@context": "https://schema.org",
        "@type": "Article",
    ...
    return {
      "@context": "https://schema.org",
      "@type": "Article",
      "@id": `https://bouncydigital.com/blog/${postData.slug}/#article`,
      "headline": postData.title,
      "description": postData.excerpt,
      "image": [`https://bouncydigital.com${postData.image}`],
      "author": {
        "@type": "Person",
      ...
      "mainEntityOfPage": {
        "@type": "WebPage",
        "@id": `https://bouncydigital.com/blog/${postData.slug}`
      },
      "datePublished": "2026-07-18",
      "dateModified": "2026-07-18",
