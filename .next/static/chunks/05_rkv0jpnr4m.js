(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,42573,e=>{"use strict";var t=e.i(43476),a=e.i(71645),o=e.i(89970);e.s(["default",0,function({children:e,className:i="",magneticStrength:n=.3,type:r="button",...s}){let l=(0,a.useRef)(null),c=(0,a.useRef)(null),d=(0,a.useRef)(null);return(0,t.jsxs)("button",{ref:l,onMouseEnter:()=>{c.current&&o.default.to(c.current,{scale:1,duration:.5,ease:"power3.out"}),d.current&&o.default.to(d.current,{color:"#ffffff",duration:.3,ease:"power2.out"})},onMouseLeave:()=>{c.current&&o.default.to(c.current,{scale:0,duration:.5,ease:"power3.out"}),d.current&&o.default.to(d.current,{color:"#000000",duration:.3,ease:"power2.out"}),l.current&&o.default.to(l.current,{x:0,y:0,duration:.6,ease:"elastic.out(1, 0.5)"})},onMouseMove:e=>{let t=l.current;if(!t)return;let a=t.getBoundingClientRect(),i=e.clientX-a.left-a.width/2,r=e.clientY-a.top-a.height/2;o.default.to(t,{x:i*n,y:r*n,duration:.3,ease:"power2.out"})},type:r,className:`group relative rounded-full border flex items-center justify-center overflow-hidden transition-all duration-300 text-black font-semibold tracking-wide z-10 cursor-pointer select-none bg-white ${i}`,...s,children:[(0,t.jsx)("div",{ref:c,className:"absolute inset-0 bg-gradient-to-br from-[#206cbb] to-[#3c9e90] rounded-full scale-0 pointer-events-none z-0",style:{transformOrigin:"center"}}),(0,t.jsx)("span",{ref:d,className:"relative z-10 pointer-events-none text-black transition-colors duration-300 flex items-center justify-center gap-1.5",children:e})]})}])},11834,e=>{"use strict";let t=[{id:"1",slug:"website-conversion-traps",title:"Why Your Business Website Isn't Converting: 5 Common Traps and How to Fix Them",category:"Web Development",date:"July 20, 2026",image:"/blog_laptop.webp",excerpt:"Discover why driving traffic to your website isn't enough, the hidden user-experience hurdles killing your conversions, and actionable steps to turn visitors into paying customers.",author:{name:"Wajeeha Javed",avatar:"/team/wajeeha_javed.webp",role:"Head Tech n Design"},readTime:"6 min read",tableOfContents:["1. Slow Page Load Times","2. Confusing Navigation Paths","3. Weak Calls to Action (CTAs)","4. Non-Responsive Mobile Layouts","5. Absence of Social Proof"],contentHtml:`
